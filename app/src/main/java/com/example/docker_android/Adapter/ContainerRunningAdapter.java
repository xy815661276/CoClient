 ...
 */
public class ContainerRunningAdapter extends RecyclerView.Adapter<ContainerRunningAdapter.ViewHolder> {
    ...
    public ContainerRunningAdapter(List<Container> classList, Context context) {
        mContext = context;
